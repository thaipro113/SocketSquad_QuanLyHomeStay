...
public class MainDashboard extends JFrame {
    ...
    private JPanel createStatisticsTab() {
        ...
        // 3. Phòng
        Object[] room = createStatCard("Tổng Số Phòng", "0", new Color(255, 152, 0), new Color(255, 243, 224));
        JLabel lblRoom = (JLabel) room[1];
        statsGrid.add((JPanel) room[0]);
        ...
        JButton btnRefresh = createStyledButton("Cập Nhật Số Liệu", PRIMARY);
        btnRefresh.addActionListener(e -> {
            ...
            if (stats != null) {
                ...
                lblRoom.setText(String.valueOf(rooms));
