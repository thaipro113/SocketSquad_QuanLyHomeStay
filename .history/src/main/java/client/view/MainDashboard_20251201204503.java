...
public class MainDashboard extends JFrame {
    ...
    private void showAddRoomDialog() {
        ...
        JComboBox<String> statusBox = new JComboBox<>(new String[] { "TRỐNG", "ĐANG THUÊ", "ĐÃ ĐẶT" });
        ...
        if (option == JOptionPane.OK_OPTION) {
            try {
                ...
                // Map Vietnamese status to English DB value
                String selectedStatus = (String) statusBox.getSelectedItem();
                String dbStatus = "AVAILABLE";
                if ("ĐANG THUÊ".equals(selectedStatus))
                    dbStatus = "OCCUPIED";
                else if ("ĐÃ ĐẶT".equals(selectedStatus))
                    dbStatus = "RESERVED";
