...
public class ClientController {
    ...
    public boolean checkoutRoom(common.models.CheckoutPayload payload) {
        try {
            Payload response = socketClient.sendRequest(new Payload(Payload.Action.CHECKOUT_ROOM, payload));
            return response.getAction() == Payload.Action.SUCCESS;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
