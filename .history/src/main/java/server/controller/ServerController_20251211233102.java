        ...
        try {
            switch (request.getAction()) {
                ...
                case CHECKOUT_ROOM: {
                    ...
                    double chkElecPrice = invoiceDAO.getServicePrice("Electricity");
                    double chkWaterPrice = invoiceDAO.getServicePrice("Water");
                    double chkInternetPrice = invoiceDAO.getServicePrice("Internet");
                    ...
                    newInvoice.setInternetFee(chkInternetPrice);
                    newInvoice.setTotalAmount(checkoutData.getTotalAmount());
                    ...
                    if (tenantToCheckout != null) {
                        tenantHistoryDAO.addToHistory(tenantToCheckout);
